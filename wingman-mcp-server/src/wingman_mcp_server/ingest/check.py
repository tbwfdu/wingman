...
from wingman_mcp_server.ingest.ingest_docs import (
    DEFAULT_SITEMAPS,
    USER_AGENT,
    _extract_bundle,
    _get_sub_sitemaps,
...
from wingman_mcp_server.ingest.ingest_api import API_MAP, _sanitize_url
from wingman_mcp_server.ingest.ingest_release_notes import (
    VERSION_MAP,
    _find_rn_file,
)
from wingman_mcp.products import PRODUCTS, ProductConfig, get_product
...
def _check_product_api(slug: str, cfg, store_dir: str) -> dict:
    ...
    from wingman_mcp_server.ingest.ingest_api import _fetch_spec
...
def _check_docs_web_rn(slug: str, cfg, vs) -> dict:
    ...
    from wingman_mcp_server.ingest.ingest_release_notes import _discover_rn_urls_for
